...
<footer class="footer pt-3  text-center mb-3">
    <div class="container-fluid">
    <div class="row col-10 align-items-center justify-content-lg-between">
        <div class="col-lg-10 mb-lg-0 mb-4 offset-3">
        <div class="copyright text-center text-sm text-muted text-lg-start">
            © <script>
            document.write(new Date().getFullYear())
            </script>,
            made with <i class="fa fa-heart"></i> by
            <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">OkaOka</a>
            for a better web.
        </div>
        </div>
    </div>
